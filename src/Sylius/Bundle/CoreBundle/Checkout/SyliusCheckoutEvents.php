...
class SyliusCheckoutEvents
{
    ...
    const CONTACTS_INITIALIZE   = 'sylius.checkout.contacts.initialize';
    const CONTACTS_PRE_COMPLETE = 'sylius.checkout.contacts.pre_complete';
    const CONTACTS_COMPLETE     = 'sylius.checkout.contacts.complete';
